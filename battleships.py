...
num_ships = 4 #number of ships added
ship_size_all = [2,3,4,5] #legnth of said ships 
num_turns = 40 #number of turns the user has to guess where the ships are
...
def random_location():
  ...
  size = ship_size_all[randint(0,len(ship_size_all)-1)]
  ship_size_all.remove(size)
